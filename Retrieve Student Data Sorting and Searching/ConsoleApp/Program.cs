...
namespace ConsoleApp
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string filePath = @"C:\Users\divya\source\repos\Retrieve Student Data from a Text File with the Option of Sorting and Searching- Oct\Retrieve Student Data Sorting and Searching\student_data.txt";
